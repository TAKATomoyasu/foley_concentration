// https://qiita.com/AiginaCoder/items/08e1cf833d6429a8ce1d
// NoTransitionを追加したよ
...
public class CreateSceneTransitionManagerScriptEditor
{
    ...
    private const string kScriptSavePath = "Assets/- Scenes/SceneTransitionManager.cs"; // 保存先
...
");
        ...
        var sceneNames = UnityEditor.EditorBuildSettings.scenes
            ...
            .Distinct()
            // .Concat(new string[] {"No Transition"})
            .ToArray();
        sceneNames = new string[] { "NoTransition" }
            .Concat(sceneNames)
            .ToArray();
